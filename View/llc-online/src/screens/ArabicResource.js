      ...
      return (
        <div>
            <div id="container" className="body">
              <section id="content">
                <h1 id="page_title">Arabic Resources</h1>
                <div id="text">
                  <div className="genContent" id="ctl1">
                    <h2><span dir="RTL">برنامج اللغة العربية<br />
                      </span>Arabic Language and&nbsp;Culture</h2>
                    <h2 style={{textAlign: 'left'}}>Learning Arabic at Loyola</h2>
                    <p style={{textAlign: 'left'}}>Loyola University Maryland Arabic courses: (<a href="https://catalogue.loyola.edu/search_advanced.php?cur_cat_oid=16&search_database=Search&search_db=Search&cpage=1&ecpage=1&ppage=1&spage=1&tpage=1&location=3&filter%5Bkeyword%5D=Arabic">university course listings website</a>).</p>
                    <h2 style={{textAlign: 'left'}}>Arabic at Loyola in the News and Social Media</h2>
                    <ul>
                      <li style={{textAlign: 'left'}}>Loyola Magazine: "<a href="https://www.loyola.edu/explore/magazine/stories/2019/learning-language-mastering-skill">Learning a Language Mastering a Skill</a>"</li>
                      <li style={{textAlign: 'left'}}>Loyola Arabic Program abroad: <a href="https://www.youtube.com/watch?v=0_Tu2AOKM7M">"Hello=Ahlan by Spiro Vas, '21"</a></li>
                      <li style={{textAlign: 'left'}}><a href="https://www.loyola.edu/news/2019/191211-clinton-scholarship-spring">Scholarship Awards for Arabic students</a></li>
                      <li style={{textAlign: 'left'}}>The Greyhound: <a href="https://thegreyhound.org/9616/news/loyola-arabic-club-hosts-arabyola-got-talent/">"Arabyola Got Talent"</a></li>
                      <li style={{textAlign: 'left'}}>Loyola Arabic e-learning: <a href="https://arabyola.myportfolio.com/">"Arabyola Portal"</a></li>
                      <li style={{textAlign: 'left'}}>Students skits in Arabic: <a href="https://www.youtube.com/watch?v=m0bqe7TUHCU&feature=emb_logo">"Featuring our Loyola Campus"</a></li>
                    </ul>
                    <h2 style={{textAlign: 'left'}}>Arabic Program Events</h2>
                    <h3 style={{textAlign: 'left'}}>Arabic Club (Arabyola) Events </h3>
                    <p>Fall events are forthcoming.</p>
                    <p>&nbsp;</p>
                    <h1 style={{textAlign: 'left'}}>External Resources</h1>
                    <h2 style={{textAlign: 'left'}}>Media in Arabic</h2>
                    <ul>
